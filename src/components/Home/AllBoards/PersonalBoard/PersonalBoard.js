...
class personalBoard extends Component {
    projectSelectedHandler = (id, name) => {
        this.props.history.push("/" + id + "/" + name);
    }
    render() {
        const personalBoard = this.props.projects.map(project => {
            return (
                <li
                    key={project.id}
                    style={{
                ...
                >
                    <div
                        ...
                        onClick={() => this.projectSelectedHandler(project.id, project.title)}
                    >
        ...
        return (
            <div className="PersonalBoard">
                ...
                <ul className="board-selection-list">
                    {personalBoard}
                    <li className="board-selection-list-item" style={{ cursor: "pointer" }} onClick={this.props.openModal}>
                        <div className="board-title-details">
